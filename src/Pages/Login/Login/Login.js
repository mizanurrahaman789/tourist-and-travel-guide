...
const Login = () => {
      ...
      const resetPassword = async () => {
            ...
            if (email) {
                  ...
                  toast('Please your email address');
            }
      }
      return (
            <div className='container w-50 mx-auto'>
                  ...
                  {errorElement}
                  <p className='text-center'>New Create Account? <Link to='/register' className='text-primary pe-auto text-decoration-none' onClick={navigateRegister}>Pleasse Register</Link></p>
